...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.workflow_status'
        db.add_column('news_article', 'workflow_status', models.ForeignKey(orm['workflow.WorkflowStatus'], null=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Article.workflow_status'
        db.delete_column('news_article', 'workflow_status_id')
