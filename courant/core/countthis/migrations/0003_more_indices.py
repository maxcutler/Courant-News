...
class Migration:
    ...
    def forwards(self, orm):
        db.create_index('countthis_statistic', ['content_type_id', 'object_id'])
        db.create_index('countthis_statistic', ['path'])


    def backwards(self, orm):
        db.delete_index('countthis_statistic', ['content_type_id', 'object_id'])
        db.delete_index('countthis_statistic', ['path'])
