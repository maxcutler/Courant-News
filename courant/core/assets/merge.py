...
from courant.core.assets.updater import get_updater
from courant.core.assets.filter import get_filter
...
def abspath(filename):
    ...
    if os.path.isabs(filename):
        return filename
    return os.path.abspath(os.path.join(settings.STATIC_ROOT, filename))
